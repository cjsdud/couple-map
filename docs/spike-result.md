...
## 추가 발견 (2026-07-19): 행정구역 개편으로 정복 단위 229 → 230

시군구 코드표 조사(교차 검증 2곳 이상, Kakao devtalk 공지 포함) 결과, **2026-07-01 개편**이 확인됨:

- **인천 행정체제 개편**: 중구+동구 → 제물포구(28125)·영종구(28155), 서구 → 서해구(28275)·검단구(28290). 기초단위 순증 +1 → **정복 단위 230개**.
- **전남광주통합특별시** 출범: 광주 5구·전남 22시군의 코드가 12xxx로 전면 재부여 (단위 수 불변). Kakao Local API도 2026-07-02부로 신코드 반환.
- 그 외 반영: 강원 42→51(2023), 전북 45→52(2024), 군위군 대구 편입 27720(2023), 부천 3구 재설치(2024), 화성 4구 신설(2026-02).
